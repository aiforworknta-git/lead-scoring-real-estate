...
description: "Tổng công trình sư điều phối luồng Multi-Agent (Master Orchestrator): Tiếp nhận 1 lệnh kinh doanh duy nhất, tự động lập kế hoạch OIPO (ai4a-brainstorm), làm sạch dữ liệu (ai4a-data-cleaner), kiến trúc dashboard/báo cáo (ai4a-build-dashboard-bi / ai4a-dashboard-architect / ai4a-erp-ops-reporter), kiểm toán chốt chặn sai số = 0 (ai4a-qa-auditor), tự động vá lỗi (ai4a-software-engineer) và xuất bản slide thuyết trình điều hành (ai4a-ppt-architect)."
user-invocable: true
...
└──────────────────────────────────────────────┬──────────────────────────────────────────────┘
                                               ...
                                               ▼
┌─────────────────────────────────────────────────────────────────────────────────────────────┐
│ 3. ANALYTICS MODELING & UI CORE (ai4a-build-dashboard-bi / ai4a-dashboard-architect)         │
