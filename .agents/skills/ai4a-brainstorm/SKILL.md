...
*(Detailed evaluation principles: [Trade-off Matrix Guide](./references/tradeoff-matrix-guide.md))*

## Course Framework Alignment

This skill seamlessly maps brainstorm results into the core course frameworks *(Detailed mappings: [Framework Alignment Reference](./references/framework-alignment.md))*:
...
- **Default (Markdown Brief):** Structured markdown summary containing the 4-field contract, compared approaches, recommended choice, and next action. *(Standard Template: [Brainstorm Report Template](./assets/brainstorm-report-template.md))*
